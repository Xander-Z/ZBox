...
from evaluation.coco import COCO
from evaluation.cocoeval import COCOeval, Params
...
class KAIST(COCO):
    ...
    def loadRes(self, anns):
        ...
        tic = time.time()
        annsImgIds = [ann['image_id'] for ann in anns]  # 获取 image id 列表
        assert set(annsImgIds) == (set(annsImgIds) & set(self.getImgIds())), \
            'Results do not correspond to current coco set'  # 检查id列表
